...
const bubbleBase =
  "flex h-14 w-14 items-center justify-center rounded-full shadow-lg ring-1 ring-black/5 transition-all duration-300 hover:scale-105 active:scale-95";
  ...
  return (
    ...
    >
      ...
      <a
        ...
        aria-label="Contacter GreenVibes sur WhatsApp"
        title="WhatsApp"
        className={cn(
          bubbleBase,
          "bg-[#25D366] text-white hover:bg-[#1ebe57] hover:shadow-xl",
        )}
      >
